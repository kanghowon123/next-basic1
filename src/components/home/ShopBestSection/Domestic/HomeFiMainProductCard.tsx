...
export default function HomeFiMainProductCard() {
  return (
    <>
        ...
        <div className="main-card bg-white flex py-10 px-5 h-[470px] rounded-3xl">
          ...
          <div className="main-card-info pl-10 flex-1 flex flex-col justify-center">
            ...
            <div className="py-4 leading-loose">
              ...
              <p className="text-[18px]">
                <span className="text-[#a5a5a5]">속도 | </span>4G/LTE 최대
                20Mbps
              </p>
            </div>
            <div className="pb-10">
      ...
      {/* 모바일 */}
      <div className="md:hidden block px-[15px]">
        <div className="text-center bg-[#cb4cff] text-white py-2.5">
          <p className="font-bold text-[20px]">WiFi & HomeFi</p>
          <p className="font-bold">인기 국내사용 제품</p>
        </div>
        <div className="bg-white text-center py-[30px]">
          <div className="px-[55px] py-4 flex justify-center">
            <Image
              src={IMAGES.shopKo1Image}
              alt="속도저하없는 고속무제한"
              className=""
          ...
          <div>
            <p className="bg-[#c565ec] text-white font-bold inline-block px-1">
              WiFi BEST
            </p>
            ...
            <p>
              <span className="text-[#c565ec] font-bold">18% </span>월 54,900원
            </p>
          </div>
        </div>
      </div>
